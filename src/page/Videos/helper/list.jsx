  ...
  return (
    <>
      ...
      <table className="table">
        <thead>
          <tr>
            <th style={{ width: "10px" }} className="th">
              №
            </th>
          ...
          {video.length ? (
            video.map((e, i) => (
              <tr key={i}>
                ...
                <td
                  onClick={() => handleOpenVideo(e.link, e.id)}
                ...
                <td onClick={() => handleOpenVideo(e.link, e.id)}>
                  {value?.id !== e.id ? (
                    e.duration
                  ) : (
                    <input
